...
import com.beauty.usercenter.rocketmq.checker.Checker;
import com.beauty.usercenter.util.HessianUtils;
...
public class MsgSenderService implements MsgSender {
    ...
    private static final String PRODUCER_GROUP = "p_tc_trans";
